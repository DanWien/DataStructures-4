        ...
        if (root == null) {
            ...
            while (currentNode != null && !wasAdded) {
                ...
                if (currentNode.getNumberOfKeys() == maxDegree - 1) {
                    // Creating a copy of the node we split to maintain the information we need for backtrack.
                    Node<T> copy = this.createPartialNodeCopy(currentNode,0,currentNode.numOfKeys);
                    copy.parent = currentNode.parent;
                    b.push(copy);
                	split(currentNode);
